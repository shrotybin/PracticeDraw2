...
public class Practice12PathEffectView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 第三处：DashPathEffect
        DashPathEffect dashPathEffect=new DashPathEffect(new float[]{6,2},5);
        ...
        path1.rLineTo(5, 8);
        path1.close();
        PathDashPathEffect pathDashPathEffect=new PathDashPathEffect(path1,20,0, PathDashPathEffect.Style.MORPH);
