...
public class Practice05ComposeShaderView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Bitmap bitmap1 = BitmapFactory.decodeResource(mContext.getResources(), R.drawable.batman_logo);

        BitmapShader bitmapShader = new BitmapShader(bitmap, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
        BitmapShader bitmapShader1 = new BitmapShader(bitmap1, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
        paint.setShader(new ComposeShader(bitmapShader,bitmapShader1, PorterDuff.Mode.DST_IN));
